...
class Definition:
    def __init__(
        ...
        self.query_argument_groups = query_argument_groups
    ...
    def __repr__(self):
        return (
            ...
            f"singularity_image={self.singularity_image!r}, "
            f"arguments={self.arguments!r}, "
            f"query_argument_groups={self.query_argument_groups!r}, "
    ...
    def __eq__(self, other):
        ...
        return (
            ...
            and self.singularity_image == other.singularity_image
            and self.arguments == other.arguments
            and self.query_argument_groups == other.query_argument_groups
            and self.disabled == other.disabled
            and self.ood == other.ood
...
def get_config_files(base_dir: str = "vibe/algorithms") -> List[str]:
...
def load_configs(point_type: str, base_dir: str = "vibe/algorithms") -> Dict[str, Any]:
...
def _get_definitions(base_dir: str = "vibe/algorithms") -> List[Dict[str, Any]]:
...
def _get_algorithm_definitions(
    point_type: str, distance_metric: str, base_dir: str = "vibe/algorithms"
...
def list_algorithms(base_dir: str = "vibe/algorithms") -> Dict[str, Any]:
    """
...
def create_definitions_from_algorithm(
    ...
    Raises:
        Exception: If the algorithm does not define "singularity_image", "module" or "constructor" properties.

    Returns:
        List[Definition]: A list of definitions created from the algorithm.
    """
    required_properties = ["singularity_image", "module", "constructor"]
    ...
    for run_group in algo["run_groups"].values():
        ...
        for arg_group in args:
            ...
            definitions.append(
                Definition(
                    algorithm=name,
                    singularity_image=algo["singularity_image"],
                    module=algo["module"],
                    constructor=algo["constructor"],
                    arguments=current_args,
                    query_argument_groups=query_args,
                    disabled=algo.get("disabled", False),
                    ood=algo.get("ood", False),
                    gpu=algo.get("gpu", False),
                )
            )
    return definitions
